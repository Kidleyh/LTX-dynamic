...
LOGFILE="$LOG_DIR/log_train_4nodes_bidirectional_lora_1080x1920_seq1_bs1_rank${NODE_RANK}_${TS}.log"
CONFIG_PATH=${CONFIG_PATH:-packages/ltx-distillation/configs/bidirectional_dmd/ltx23_bidirectional_dmd_lora_lyh_1080x1920_249f_normalopt_seq1_bs1_4node.yaml}
RUN_NAME=${RUN_NAME:-ltx23_bidirectional_dmd_lora_4nodes_1080x1920_249f_normalopt_seq1_bs1_cpuoffload_8step_log500_$(date +'%m%d_%H%M')}
...
echo "[$(date +'%F %T')] Start 4-node LTX23 bidirectional LoRA-DMD 1080x1920 training"
