...
LOGFILE="$LOG_DIR/log_train_4nodes_bidirectional_seq1_bs1_rank${NODE_RANK}_${TS}.log"
CONFIG_PATH=${CONFIG_PATH:-packages/ltx-distillation/configs/bidirectional_dmd/ltx23_bidirectional_dmd_lyh_512x768_121f_normalopt_seq2_bs1_4node.yaml}
RUN_NAME=${RUN_NAME:-ltx23_bidirectional_dmd_4nodes_512x768_121f_normalopt_seq1_bs1_cpuoffload_8step_log500_$(date +'%m%d_%H%M')}
...
echo "[$(date +'%F %T')] 启动 4-node LTX23 bidirectional DMD 训练"
...
wait $PID
EXIT_CODE=$?
echo "[$(date +'%F %T')] 训练结束，退出码: $EXIT_CODE"
exit $EXIT_CODE
