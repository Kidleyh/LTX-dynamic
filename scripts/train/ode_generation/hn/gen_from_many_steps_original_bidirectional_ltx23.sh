...
torchrun \
  ...
  --video_save_path /gemini/platform/public/aigc/human_guozz2/code/hys/LTX-2/ode_data/0507_multisteps_ode/videos \
  --ode_save_path /gemini/platform/public/aigc/human_guozz2/code/hys/LTX-2/ode_data/0507_multisteps_ode/ode_samples \
