...
CONFIG_PATH=${CONFIG_PATH:-packages/ltx-distillation/configs/causal_dmd/ltx23_causal_dmd_lyh_512x768_121f_normalopt_seq5.yaml}
RUN_NAME=${RUN_NAME:-ltx23_causal_dmd_2nodes_512x768_121f_normalopt_seq5_cpuoffload_$(date +%m%d_%H%M)}
