...
from LTX_2.ltx_core.guidance.perturbations import BatchedPerturbationConfig, PerturbationType
...
class BasicAVTransformerBlock(torch.nn.Module):
    ...
    def _apply_text_cross_attention(
        ...
        kv_cache_variable: dict | None = None,
    ) -> torch.Tensor:
        ...
        if run_vx:
            ...
            vx = (
                ...
                + self.attn1(
                    ...
                    kv_cache_variable=kv_cache_variable,
                )
                * vgate_msa
            )
...
def apply_cross_attention_adaln(
    ...
    return attn(attn_input, context=encoder_hidden_states, mask=context_mask, kv_cache=kv_cache, kv_cache_name=kv_cache_name, kv_cache_variable=kv_cache_variable) * q_gate
