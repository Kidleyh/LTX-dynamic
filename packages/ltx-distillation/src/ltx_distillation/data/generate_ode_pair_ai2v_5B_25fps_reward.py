...
from pipeline import OdeGenerationWan5BPipeline
from examples.infer_sample_config.ode_samples_16fps_openhuman_vid_003_005 import TEST_SAMPLES
"""
...
tmux new -s infer2
conda deactivate
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_gd_hengping_1 > log1.log 2>&1 &
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_gd_shuping_1_0 > log2.log 2>&1 &
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_gd_shuping_1_1 > log3.log 2>&1 &
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_sora2pro1_0 > log4.log 2>&1 &
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_sora2pro1_3 > log5.log 2>&1 &
nohup python wan/data/generate_ode_pair_ai2v_5B_25fps.py --config_path configs/ode_data_generation_ai2v_25fps_5B_3step_noreward_0107.yaml --output_folder ode_samples_25fps_5B_nolora_gs5_640p/ode_samples_16fps_openhuman_vid_003_005 > log6.log 2>&1 &    
...
def run_test(sample_id, test_data, device, rank):
    ...
    if lora_dir is not None:
        if "lightx2v" in lora_dir[0]:
            ...
            config.guidance_scale = 1.0
    lora_scales = [1.0]
    lora_path_vxf = "/gemini/platform/public/aigc/human_guozz2/code/hzh/VideoX-Fun/output_dir/checkpoint-6000.safetensors"
    # AI2VWRAPPER里面默认读取了transformer/的权重
    pipeline = OdeGenerationWan5BPipeline(config, device=device, lora_dir=lora_dir, lora_scales=lora_scales, sampling_steps=sampling_steps,
                                          lora_path_2=lora_path_vxf)
    ...
    for input_data in input_data_list:
        try:
            ...
            if return_video:
                ...
                write_video(temp_video_path, video[0].permute(3,1,2,0), fps=25)
...
if __name__ == '__main__':
    main()
    # for i, (sample_id, test_data) in enumerate(TEST_SAMPLES.items()):
    #     result = run_test(sample_id, test_data, torch.device(f'cuda:{0}'), 0)


"""
python wan/data/generate_ode_pair_ai2v.py --config_path configs/ode_data_generation_ai2v.yaml --output_folder ode_samples/celebv_text_01
"""