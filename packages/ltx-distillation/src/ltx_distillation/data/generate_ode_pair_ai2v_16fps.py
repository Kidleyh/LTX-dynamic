...
from examples.infer_sample_config.ode_samples_16fps_openhuman_vid_005 import TEST_SAMPLES
...
def run_test(sample_id, test_data, device, rank):
    ...
    pipeline = OdeGenerationPipeline(config, device=device, lora_dir=lora_dir, lora_scales=lora_scales, sampling_steps=sampling_steps)
...
"""
python wan/data/generate_ode_pair_ai2v_16fps.py --config_path configs/ode_data_generation_ai2v_16fps_gz.yaml --output_folder ode_samples_16fps/celebv_text_01
python wan/data/generate_ode_pair_ai2v_16fps.py --config_path configs/ode_data_generation_ai2v_16fps_gz_757_reward.yaml --output_folder ode_samples_16fps_reward_lora/openhuman_vid_001
"""