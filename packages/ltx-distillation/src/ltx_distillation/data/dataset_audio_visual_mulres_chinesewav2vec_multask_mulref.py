...
class AudioVisualDataset(Dataset):
    def __init__(
            ...
            dataset_paths_txt=[],
            sample_type="jump_chunks_from_first",
        ):
        ...
        transforms_dict=[
            dict(
                type="SampleImages",
                num_frames=video_sample_n_frames,
                sample_type=sample_type, # second chunk可能和first chunk相隔一段距离
...
if __name__ == "__main__":
    train_dataset = AudioVisualDataset(
        ...
        dataset_paths_txt="/gemini/platform/public/aigc/human_guozz2/code/hys/longtalker_0113/wan/data/dataset_txts/debug_hn2.txt"
    )