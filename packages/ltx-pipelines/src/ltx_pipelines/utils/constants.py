...
GENERAL_NOSPEECH_PROMPT = (
    "A realistic video from a single image where the main subject stays consistent with only subtle natural motion "
    "(slight breathing, blinking, or gentle environmental changes), no large or sudden movement, fixed camera, "
    "consistent background lighting, no talking or lip movement, smooth motion"
)